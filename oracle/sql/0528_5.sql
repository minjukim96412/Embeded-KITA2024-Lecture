...
CREATE TABLE BOARD(
   BID NUMBER PRIMARY KEY, 
	BTITLE VARCHAR2(2000) NOT NULL ENABLE, 
	BCONTENT VARCHAR2(4000), 
	BREGDATE TIMESTAMP (6) 
	);
...
IS BEGIN 
	INSERT INTO BOARD VALUES(SEQ_BOARD.NEXTVAL, P_BTITLE, P_BCONTENT, SYSDATE);
END;
...
CREATE OR REPLACE PROCEDURE PROC_INOUT
	(NUM IN OUT NUMBER)
IS BEGIN 
	SELECT NUM + 1 INTO NUM FROM DUAL;
END;
