...
public class StudentScoreMain {
	...
	public static void main(String[] args) {
		...
		int hongSum = sumOfStuentScore(ss1); 
		int kangSum = sumOfStuentScore(ss2); 
		int leeSum = sumOfStuentScore(ss3); 
		...
		System.out.printf("%s %6s %6s %6s %6s %6s","이름","국어","영어","수학","총점","평균");
		System.out.println();
	...
	//1.학생별 총점 메소드
	static int sumOfStuentScore(StudentScore ss) {
